...
import convenient from "@images/category/convenientProd-1.png";

const Convenient = async () => {
  const breadcrumbPaths = [{ url: "/", label: "Trang chủ" }];
  const currentPage = "Sản phẩm tiện lợi";
  ...
  return (
    <>
      ...
      <div className="container max-w-[1232px] mx-auto">
        <div>
          <p className="text-2xl font-semibold">Sản phẩm tiện lợi</p>
        </div>
